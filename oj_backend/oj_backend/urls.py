...
urlpatterns = [
    ...
    path('student/<str:id>/', views.studentInfomation.as_view()),
    ...
    path('insturctor/<str:id>/', views.insturctorInfomation.as_view()),
    path('insturctor/<str:id>/course/', views.instructorCourseList.as_view()),
