    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uid', models.CharField(default=oj_backend.backend.models.uuid1str,
                                         editable=False, max_length=32, unique=True, verbose_name='唯一标识符')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True,
                                        primary_key=True, serialize=False, verbose_name='ID')),
                ('uid', models.CharField(default=oj_backend.backend.models.uuid1str,
                                         editable=False, max_length=32, unique=True, verbose_name='课程唯一标识符')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True,
                                        primary_key=True, serialize=False, verbose_name='ID')),
                ('uid', models.CharField(default=oj_backend.backend.models.uuid1str,
                                         editable=False, max_length=32, unique=True, verbose_name='用户标识符')),
