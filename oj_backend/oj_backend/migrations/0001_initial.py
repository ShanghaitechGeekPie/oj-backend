...
# Generated by Django 2.1.3 on 2018-12-13 05:26

from django.conf import settings
from django.db import migrations, models
import django.db.models.deletion
import oj_backend.database.models
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Assignment',
            fields=[
                ('uid', models.CharField(default=oj_backend.database.models.uuid1str, editable=False,
                ...
                ('state', models.IntegerField(default=1, verbose_name='发布状态')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.CharField(max_length=32, verbose_name='创建者UID')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cert', models.FileField(upload_to='', verbose_name='证书')),
            ],
            options={
                'ordering': ['uid'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('upstream', models.URLField(primary_key=True,
                                             serialize=False, verbose_name='上游链接')),
                ('timestamp', models.DateTimeField(verbose_name='时间戳')),
                ('assigenment', models.ForeignKey(
        ...
        migrations.AddField(
            model_name='course',
            name='judger',
            field=models.ManyToManyField(to='oj_backend.Judger'),
        ),
        migrations.AddField(
